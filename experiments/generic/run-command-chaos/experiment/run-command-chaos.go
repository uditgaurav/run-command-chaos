...
import (
	...
	litmusLIB "github.com/litmuschaos/litmus-go/chaoslib/litmus/run-command-chaos/lib"
	clients "github.com/litmuschaos/litmus-go/pkg/clients"
	"github.com/litmuschaos/litmus-go/pkg/events"
	experimentEnv "github.com/litmuschaos/litmus-go/pkg/generic/run-command-chaos/environment"
...
// RunCommandChaos inject the run-command-chaos chaos
func RunCommandChaos(clients clients.ClientSets) {
	...
	if err := result.ChaosResult(&chaosDetails, clients, &resultDetails, "SOT"); err != nil {
		...
		failStep := "[pre-chaos]: Failed to update the chaos result of run-command-chaos experiment (SOT), err: " + err.Error()
	...
	// Including the litmus lib for run-command-chaos
	switch experimentsDetails.ChaosLib {
	case "litmus":
		if err := litmusLIB.PrepareRunCommandChaos(&experimentsDetails, clients, &resultDetails, &eventsDetails, &chaosDetails); err != nil {
